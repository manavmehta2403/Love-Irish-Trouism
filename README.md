# Love-Irish-Trouism
**Add the following lines in each views.xaml file:**
```xaml
xmlns:prism="http://prismlibrary.com/"
prism:ViewModelLocator.AutoWireViewModel="True"
xmlns:viewmodels="clr-namespace:{ProjectName}.ViewModels" 
xmlns:d="http://schemas.microsoft.com/expression/blend/2008" 
d:DataContext="{d:DesignInstance Type=viewmodels:{ViewModelName}}"
...
## Text Place holders
Call this style   <ResourceDictionary Source="/LIT.Core;component/Styles/TextBoxStyles.xaml"/>
```
...
Simple property
```
public class RegistrationForm : DomainObject<RegistrationForm>
{
    private string name;
    ...
    {
        get => name;
        set => SetPropertyWithValidation(ref name, value, true);
    }
}
```
...
public class RegistrationForm : DomainObject<RegistrationForm>
{
    ...
    {
        get => this.name;
        set => SetPropertyWithValidation(ref this.name, value, true);
    }
...
Usage
```
public class YourViewModel : DomainObject<YourViewModel>
    {
        ...
        {
            get => _name;
            set => SetPropertyWithValidation(ref _name, value);
        }
...
Make sure to use this namespace for grid (ge/gr/resGridex)
```
xmlns:{name_your choice}="clr-namespace:LIT.Core.Controls.GridExtensions;assembly=LIT.Core"
```
...
```
### (1. Example) WrapPanelEx **(WPF Only)**
...
```xml
    <Grid>
        ...
        <WrapPanel ItemWidth="200" ItemHeight="70"
                   ...
                   controls:WrapPanelEx.AdaptiveLayout="{Binding IsChecked, ElementName=chkIsAdaptive}">
            <Button />
            <Button />
            <Button />
            <Button />
