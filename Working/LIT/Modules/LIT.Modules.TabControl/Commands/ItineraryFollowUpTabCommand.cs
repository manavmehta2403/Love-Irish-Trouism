...
{
    public class ItineraryFollowUpTabCommand : IOperations
    {
        ...
        public readonly ItineraryFollowUpTabViewModel FuviewModel;
        public ItineraryFollowUpTabCommand(ItineraryFollowUpTabViewModel viewModel)
        {
        ...
        private void SaveFollowUpTaskCommandExecute()
        {
            ...
            foreach (FollowupModel objfu in FuviewModel.Folluptaskfull)
            {
                ...
                {
                    if (((LIT.Modules.TabControl.Commands.ItineraryFollowUpTabCommand)((System.Delegate)SaveFollowUpTaskCommandExecute).Target).FuviewModel.Loginuserid != null)
                        FuviewModel.objFollup.CreatedBy = ((LIT.Modules.TabControl.Commands.ItineraryFollowUpTabCommand)((System.Delegate)SaveFollowUpTaskCommandExecute).Target).FuviewModel.Loginuserid;
                }
                else
                {
                ...
                {
                    if (((LIT.Modules.TabControl.Commands.ItineraryFollowUpTabCommand)((System.Delegate)SaveFollowUpTaskCommandExecute).Target).FuviewModel.Loginuserid != null)
                        FuviewModel.objFollup.ModifiedBy = ((LIT.Modules.TabControl.Commands.ItineraryFollowUpTabCommand)((System.Delegate)SaveFollowUpTaskCommandExecute).Target).FuviewModel.Loginuserid;
                }
                else
                {
                ...
                {
                    if (((LIT.Modules.TabControl.Commands.ItineraryFollowUpTabCommand)((System.Delegate)SaveFollowUpTaskCommandExecute).Target).FuviewModel.Loginuserid != null)
                        FuviewModel.objFollup.DeletedBy = ((LIT.Modules.TabControl.Commands.ItineraryFollowUpTabCommand)((System.Delegate)SaveFollowUpTaskCommandExecute).Target).FuviewModel.Loginuserid;
                }
                else
                {
        ...
        {
            ItineraryFollowUpTabViewModel fnvmobj = ((LIT.Modules.TabControl.Commands.ItineraryFollowUpTabCommand)((System.Delegate)ReteriveCommandExecute).Target).FuviewModel;
            if (fnvmobj != null)
            {
