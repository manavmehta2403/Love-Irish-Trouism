...
{
    public class ItineraryClientTabViewModel : BindableBase
    {
        ...
        private bool _RefundPaymentTotalAmountcheck;
        ...
        private bool _Individualoption;
        ...
        public bool Groupoption { get { return _Groupoption;  } set { SetProperty(ref _Groupoption,  value); } }

        public bool Individualoption { get { return _Individualoption; } set { SetProperty(ref _Individualoption, value); } }

        private bool _rbselected;
        public bool Rbselected { get { return _rbselected; } set { SetProperty(ref _rbselected, value); } }
        ...
        public bool RefundPaymentTotalAmountcheck
        {
            get { return _RefundPaymentTotalAmountcheck; }
            set
            {
                SetProperty(ref _RefundPaymentTotalAmountcheck, value);
            }
        }
        public decimal RefundPaymentTotalAmount
        {
            ...
            set
            {
                ...
                if(_RefundPaymentTotalAmount==0)
                {
                    RefundPaymentTotalAmountcheck = true;
                }
                else
                {
                    RefundPaymentTotalAmountcheck=false;
                }
            }
        }
        ...
        {
            get { return _FinalPaymentAmount; }
            set
            {
                SetProperty(ref _FinalPaymentAmount, value);
            }
        }
        public string TotalAmountstring
        {
            ...
            set
            {
                SetProperty(ref _TotalAmountstring, value);
            }
        }
        ...
        public ObservableCollection<string> Payeeval
        {
            ...
            {
                // _Payeeval = value;
                SetProperty(ref _Payeeval, value);
        ...
        public ObservableCollection<string> PassengerStatusval
        {
            ...
            set
            {
                SetProperty(ref _PassengerStatusval, value);
        ...
        private ObservableCollection<Salutation> _Passengersalutationlist;
        public ObservableCollection<Salutation> Passengersalutationlist
        {
            get { return _Passengersalutationlist ?? (_Passengersalutationlist = new ObservableCollection<Salutation>()); }
            set
            {
                SetProperty(ref _Passengersalutationlist, value);
               // _CTPassengerCommand.RaiseCanExecuteChanged();
            }
        }
        ...
        public ObservableCollection<CommonValueCountrycity> PassengerCountrylist
        {
            ...
            private ObservableCollection<CommonValueCountrycity> _PassengerStatelist;
        public ObservableCollection<CommonValueCountrycity> PassengerStatelist
        {
            get { return _PassengerStatelist ?? (_PassengerStatelist = new ObservableCollection<CommonValueCountrycity>()); }
            set
            {
                SetProperty(ref _PassengerStatelist, value);
                // _CTPassengerCommand.RaiseCanExecuteChanged();
            }
        }

        private ObservableCollection<CommonValueCountrycity> _PassengerRegionlist;
        public ObservableCollection<CommonValueCountrycity> PassengerRegionlist
        {
            get { return _PassengerRegionlist ?? (_PassengerRegionlist = new ObservableCollection<CommonValueCountrycity>()); }
            set
            {
                SetProperty(ref _PassengerRegionlist, value);
                // _CTPassengerCommand.RaiseCanExecuteChanged();
            }
        }
        private ObservableCollection<CommonValueCountrycity> _PassengerCitylist;
        public ObservableCollection<CommonValueCountrycity> PassengerCitylist
        {
            get { return _PassengerCitylist ?? (_PassengerCitylist = new ObservableCollection<CommonValueCountrycity>()); }
            set
            {
                SetProperty(ref _PassengerCitylist, value);
                // _CTPassengerCommand.RaiseCanExecuteChanged();
            }
        }
        ...
        public ObservableCollection<PassengerDetails> PassengerDetailsobser
        {
            ...
            set
            {
                ...
                this.OnPropertyChanged(new PropertyChangedEventArgs("PassengerDetailsobser"));
                //_CTPassengerCommand.RaiseCanExecuteChanged();
                //_CTPassengerCommand.RaiseCanExecuteChanged();
            }
        }
        ...
        public ObservableCollection<PaymentDetails> PaymentRefundObser
        {
            ...
            set
            {
                SetProperty(ref _PaymentRefundObser, value);
            }
        }
        ...
        public PassengerDetails objpassdet
        {
            get { return _objpassdet; }
            set
            {
                SetProperty(ref _objpassdet, value);
            }
        }

        public PaymentDetails objpayment
        {
            get { return _objpayment; }
            set
            {
                SetProperty(ref _objpayment, value);
            }
        }
        public RoomTypesClienttab objroomTypeclienttab
        {
            get { return _objroomTypeclienttab; }
            set
            {
                SetProperty(ref _objroomTypeclienttab, value);
            }
        }
        public Paxinformationdata objpaxinformation
        {
            get { return _objpaxinformation; }
            set
            {
                SetProperty(ref _objpaxinformation, value);
            }
        }

        private PassengerDetails _objpassdet;
        private PaymentDetails _objpayment;
        private RoomTypesClienttab _objroomTypeclienttab;
        private Paxinformationdata _objpaxinformation;
        ...
        #region "Constructor"
        public ItineraryClientTabViewModel()//IRegionManager regionManager) :
           // base(regionManager)
        {
            ...
            objpaxinformation = new Paxinformationdata();
    ...
    public class Itinerary_ClientTabPassengerViewModel : DomainObject<Itinerary_ClientTabPassengerViewModel>
    {
        ...
        public object _PassengerGroupNameselectedItem;
        ...
        //public string Email { get { return _Email; } set { SetProperty(ref _Email, value,true);

        //        //if (String.IsNullOrEmpty(_Email))
        //        //{
        //        //   // _validationErrors[nameof(Text)] = "Email should not be empty";
        ...
        //[CustomValidation(typeof(Itinerary_ClientTabPassengerViewModel), nameof(Email))]
        //public string Email
        //{
        //    get => _Email;
        //    set
        //    {
        //        SetPropertyWithValidation(ref _Email, value);
        //    }
        //}
        ...
        //    // Check if there are validation errors for the specified property
        //    var validationErrors = GetErrors(propertyName);

        //    if (validationErrors != null && validationErrors.Count() > 0)
        //    {
        //        // Show a message box with the validation error message(s)
        //        MessageBox.Show(string.Join("\n", validationErrors), "Validation Error", MessageBoxButton.OK, MessageBoxImage.Error);
        //    }
        //}

        //public static ValidationResult ValidateName(string Email, ValidationContext context)
        //{
        //    Itinerary_ClientTabPassengerViewModel instance = (Itinerary_ClientTabPassengerViewModel)context.ObjectInstance;
        //    bool isValid = instance.service.Validate(Email);
        ...
        public object SalutationSelectedItem { get { return _SalutationSelectedItem; } set { SetProperty(ref _SalutationSelectedItem, value); } }

        public bool LeadPassenger { get { return _LeadPassenger; } set { SetProperty(ref _LeadPassenger, value); } }

        public object PassengerGroupNameselectedItem
        {
            get { return _PassengerGroupNameselectedItem; }
            set { SetProperty(ref _PassengerGroupNameselectedItem, value); }
        }
