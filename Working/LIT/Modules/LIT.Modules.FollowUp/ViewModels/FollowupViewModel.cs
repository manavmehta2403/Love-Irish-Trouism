...
{
    public class FollowupViewModel : BindableBase
    {

        private readonly FollowUpCommand _followCommand;

        public FollowUpCommand followCommand { get; set; }
        ...
        public FollowupViewModel()
        {
            ...
            followCommand = new FollowUpCommand(this);
            IntrFollowupViewModel = new FollowUpCommand(this);
        }
