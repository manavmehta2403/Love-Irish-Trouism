...
namespace SQLDataAccessLayer.SQLHelper
{
    ...
    {
        public static SqlParameter[] parameters = null;
        ...
        public static int outputparamExecuteNonQuery(string connectionString, string spName, params object[] parameterValues)
        {
            if (connectionString == null || connectionString.Length == 0) throw new ArgumentNullException("connectionString");
            if (spName == null || spName.Length == 0) throw new ArgumentNullException("spName");
        ...
        public static void inputparams(string paramname, int paramsize, object paramvalue, object paramtype)
        {
            if (parameters == null)
            {
            ...
            parameters[parameters.Length - 1].ParameterName = paramname;
            parameters[parameters.Length - 1].Size = paramsize;
            parameters[parameters.Length - 1].Value = paramvalue;
            parameters[parameters.Length - 1].SqlDbType = (SqlDbType)paramtype;
            parameters[parameters.Length - 1].Direction = ParameterDirection.Input;
        }

        public static void outparams(string paramname, int paramsize, object paramtype)
        {
            if (parameters == null)
            {
                Array.Resize(ref parameters, 1);
