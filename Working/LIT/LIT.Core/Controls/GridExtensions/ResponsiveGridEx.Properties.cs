...
namespace LIT.Core.Controls.GridExtensions
{
    ...
    {
        #region Dependency properties to set on the Responsive Grid itself
        // Properties for setting various breakpoints
        ...
        public GridBreakPoints BreakPoints
        {
            get { return (GridBreakPoints)GetValue(BreakPointsProperty); }
        ...
        #region Attached property for sizing each child element
        ...
        #region Properties for read -only
