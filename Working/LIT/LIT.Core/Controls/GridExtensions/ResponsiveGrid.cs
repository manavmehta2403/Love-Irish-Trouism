...
namespace LIT.Core.Controls.GridExtensions
{
    public partial class ResponsiveGrid : Panel
    {
        ...
        {
            this.MaxDivision = 12;
            this.BreakPoints = new GridBreakPoints();
        }
        ...
        // Definition of the pen used when displaying with Show Grid Lines
        ...
        {
            base.OnRender(dc);
            // If Show Grid Lines is enabled, draw a guiding grid before drawing the various elements.
